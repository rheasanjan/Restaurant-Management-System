...
<body background="view_bookingjpg.jpg">
  <center>
    ...
    ?>
    <p style="color:white;font-family:cursive;font-size:34px"> <b> Restaurant Management System </b> </p>
  <p style="color: red;font-family:cursive; font-size:27px"> <b> View Table Bookings</b> </p>
  <div id="view">
